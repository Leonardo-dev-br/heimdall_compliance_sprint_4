...
- A Collection inclui um *pre-request script* para o POST que tenta excluir a motocicleta antes de criar, evitando falhas por duplicidade.
...
---
> Caso os nomes dos campos do DTO sejam diferentes (ex.: `idMotorcycle`, `licensePlate`, etc.), informe para que a Collection seja ajustada.
